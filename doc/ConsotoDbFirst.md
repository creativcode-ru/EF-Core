...
Как начать работать с консольным приложением, смотрите в этом видео: ▶ [Getting Started with Entity Framework Core [1 of 5]](https://channel9.msdn.com/Series/Entity-Framework-Core-101/Getting-Started-with-Entity-Framework-Core)  
