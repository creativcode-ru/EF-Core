...
## [Конфликты параллелизма](https://docs.microsoft.com/ru-ru/aspnet/core/data/ef-rp/concurrency?view=aspnetcore-3.1&tabs=visual-studio)
...
* [Обнаружение конфликтов параллелизма](https://docs.microsoft.com/ru-ru/aspnet/core/data/ef-rp/concurrency?view=aspnetcore-3.1&tabs=visual-studio#conflict-detection-in-ef-core) - обработки исключений `DbConcurrencyException` - требует настройки БД и модели. В БД включаетя столбец отслеживания `rowversion`, он изменяется при каждом обновлении, и включается в запрос UPDATE или DELETE как часть предложения WHERE.  
* [Добавление свойства отслеживания в БД](https://docs.microsoft.com/ru-ru/aspnet/core/data/ef-rp/concurrency?view=aspnetcore-3.1&tabs=visual-studio#add-a-tracking-property)  
...
📘 [Маркеры параллелизма в EF Core](https://docs.microsoft.com/ru-ru/ef/core/modeling/concurrency?tabs=data-annotations)  
📘 [Обработка параллелизма в EF Core](https://docs.microsoft.com/ru-ru/ef/core/saving/concurrency)  
📘 [Отладка источника ASP.NET Core 2.x]()  
📘 [Реализация наследования, пример с MVC](https://docs.microsoft.com/ru-ru/aspnet/core/data/ef-mvc/inheritance?view=aspnetcore-3.1)    
📘 [Сведения о сложных сценариях для ASP.NET MVC с EF Core](https://github.com/creativcode-ru/EF-Core/edit/master/doc/EF-Core-Razor-Pages.md)  
